...
\\[-3pt]
\scriptsize Slides: \href{http://bit.ly/qrw2016}{\tt \scriptsize
  \color{foreground} bit.ly/qrw2016}
}
...
\note{
  ...
  Week conference in Nelson, New Zealand, on 1 Sep 2016. The slides
  were changed a bit each time.
  ...
  Slides with notes: {\tt bit.ly/qrw2016}

  Slides without notes: {\tt bit.ly/qrw2016\_nonotes}
}
...
\vspace*{15mm}
\hfill
\only<2 | handout 0>{\includegraphics[height=1.7in]{Figs/nonrec_illustrationA.pdf}}
\only<3>{\includegraphics[height=1.7in]{Figs/nonrec_illustrationB.pdf}}
...
\vspace*{15mm}
\hfill
\only<2|handout 0>{\includegraphics[height=1.7in]{Figs/effect_illustrationA.pdf}}
\only<3>{\includegraphics[height=1.7in]{Figs/effect_illustrationB.pdf}}
