...
\\[-3pt]
\scriptsize {\lolit Slides:} \href{http://bit.ly/CTC2015}{\tt \scriptsize
...
\begin{frame}[c]{}
\centerline{\Large Consider the {\hilit non-recombinants}\dots}
\end{frame}
...
\begin{frame}[c]{Fine-mapping c6 locus}
